...
Botkit Studio Skill module to enhance the "Interest Indicator" script
...
module.exports = function(controller) {
    ...
    controller.studio.before('Interest Indicator', function(convo, next) {
    ...
    controller.studio.validate('Interest Indicator','question_1', function(convo, next) {
        ...
        console.log('VALIDATE: Interest Indicator VARIABLE: question_1');
...
/*
    ...
    controller.studio.validate('Interest Indicator','question_2', function(convo, next) {
        ...
        console.log('VALIDATE: Interest Indicator VARIABLE: question_2');
    ...
    controller.studio.validate('Interest Indicator','question_3', function(convo, next) {
        ...
        console.log('VALIDATE: Interest Indicator VARIABLE: question_3');
...
*/
    ...
    controller.studio.after('Interest Indicator', function(convo, next) {

        console.log('AFTER: Interest Indicator');
